...
struct Context {
    ...
    MemSlice talloc(mem::AllocInfo info) const { return temp.alloc(this, info); }
    ...
    void tdealloc(MemSlice mem) const { return temp.dealloc(this, mem); }
    ...
    MemSlice trealloc(MemSlice old_mem, mem::AllocInfo new_info) const {
        return temp.realloc(this, old_mem, new_info);
    }
